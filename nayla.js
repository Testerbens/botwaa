...
const { bayarLimit, confirmATM, limitAdd, addATM } = require('./lib/limitatm.js')
...
const satu1 = {
text: "Apakah anda yakin menghapus database??? ini akan menghapus keseluruhan(Semua) limit, daftar, karakter, HP, uang, listpemenang, dll",footer: 'Loading... y/n?',buttons: dua1,headerType: 1}
